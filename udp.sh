...
wget https://raw.githubusercontent.com/CorPID01/CorpSc/main/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
sleep 1
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://raw.githubusercontent.com/CorPID01/CorpSc/main/udp-custom-linux-amd64" -O /root/udp/udp-custom && rm -rf /tmp/cookies.txt
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://raw.githubusercontent.com/CorPID01/CorpSc/main/config.json" -O /root/udp/config.json && rm -rf /tmp/cookies.txt
