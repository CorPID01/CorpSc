...
wget -q -O xray.conf https://raw.githubusercontent.com/CorPID01/CorpSc/main/xray.conf && chmod +x xray.conf && ./xray.conf
sleep 1 
...
cd /usr/bin/
# vmess
wget -O add-ws "https://raw.githubusercontent.com/CorPID01/CorpSc/main/add-ws.sh" && chmod +x add-ws
...
# vless
wget -O add-vless "https://raw.githubusercontent.com/CorPID01/CorpSc/main/add-vless.sh" && chmod +x add-vless
...
# trojan
wget -O add-tr "https://raw.githubusercontent.com/CorPID01/CorpSc/main/add-tr.sh" && chmod +x add-tr
...
# shadowsocks
wget -O add-ssws "https://raw.githubusercontent.com/CorPID01/CorpSc/main/add-ssws.sh" && chmod +x add-ssws
