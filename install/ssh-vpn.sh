...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/CorPID01/CorpSc/main/squid3.conf"
...
wget "https://raw.githubusercontent.com/CorPID01/CorpSc/main/vpn.sh"
chmod +x vpn.sh
./vpn.sh
